const users= [
    
    {
        ...
        location:"Taiwan",
        artistType:[{value:"Songwriter",label:"Songwriter"},{value:"Singer",label:"Singer"}],  //checkbox  https://soundbetter.com/s
        genre:"Pop-rock, rock",
        instrument:[{value:"Keyboard",label:"Keyboard"},{value:"Drum",label:"Drum"}],  //checkbox https://soundbetter.com/s
    ...
    },
    {
        ...
        location:"New York",
        genre:"Rock",
        instrument:[{value:"Guitar",label:"Guitar"},{value:"Drum",label:"Drum"}],  //checkbox https://soundbetter.com/s
    ...
    },
    {
        ...
        description: "Virtute equidem ceteros in mel. Id volutpat neglegentur eos. Eu eum facilisis voluptatum, no eam albucius verterem. Sit congue platonem adolescens ut. Offendit reprimique et has, eu mei homero imperdiet.Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.",        
        artistType:[{value:"Composer",label:"Composer"},{value:"Singer",label:"Singer"}],  //checkbox  https://soundbetter.com/s
        location:"California",
        genre:"Pop rock, indie pop, alternative music, folk rock",
        instrument:[{value:"Guitar",label:"Guitar"},{value:"Accordion",label:"Accordion"}],  //checkbox https://soundbetter.com/s
    ...
    },
    {
        ...
        description: "Virtute equidem ceteros in mel. Id volutpat neglegentur eos. Eu eum facilisis voluptatum, no eam albucius verterem. Sit congue platonem adolescens ut. Offendit reprimique et has, eu mei homero imperdiet.Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.",        
        artistType:[{value:"Songwriter",label:"Songwriter"},{value:"Singer",label:"Singer"},{value:"Producer",label:"Producer"}],  //checkbox  https://soundbetter.com/s
        location:"France",
        genre:"Indie pop, indietronica, folk-pop, new wave",
        instrument:[{value:"Guitar",label:"Guitar"},{value:"Bass",label:"Bass"},{value:"Keyboard",label:"Keyboard"}],  //checkbox https://soundbetter.com/s
    ...
    },
    {
        ...
        description: "Virtute equidem ceteros in mel. Id volutpat neglegentur eos. Eu eum facilisis voluptatum, no eam albucius verterem. Sit congue platonem adolescens ut. Offendit reprimique et has, eu mei homero imperdiet.Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.",        
        artistType:[{value:"Beatmaker",label:"Beatmaker"},{value:"Producer",label:"Producer"}],  //checkbox  https://soundbetter.com/s
        location:"USA",
        genre:"AmericanaCountryEDMPopPop-RockRock",
        instrument:[{value:"Ukelele",label:"Ukelele"},{value:"Piano",label:"Piano"},{value:"Sax",label:"Sax"}],  //checkbox https://soundbetter.com/s
    ...
    },
    {
        ...
        location:"Taiwan",
        genre:"Pop",
        instrument:[{value:"Guitar",label:"Guitar"},{value:"Violin",label:"Violin"}],  //checkbox https://soundbetter.com/s
    ...
    },
    {
        ...
        instrument:[{value:"Piano",label:"Piano"}],  //checkbox https://soundbetter.com/s
    ...
    },
    {
        ...
        description: "Virtute equidem ceteros in mel. Id volutpat neglegentur eos. Eu eum facilisis voluptatum, no eam albucius verterem. Sit congue platonem adolescens ut. Offendit reprimique et has, eu mei homero imperdiet.Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.",        
        artistType:[{value:"Producer",label:"Producer"}],  //checkbox  https://soundbetter.com/s
        location:"USA",
        genre:"Americana, Country, Electronic, Folk / Acoustic, Soft Pop",
        instrument:[{value:"Guitar",label:"Guitar"},{value:"Keyboard",label:"Keyboard"}],  //checkbox https://soundbetter.com/s
    ...
    },
    {
        ...
        description: "Virtute equidem ceteros in mel. Id volutpat neglegentur eos. Eu eum facilisis voluptatum, no eam albucius verterem. Sit congue platonem adolescens ut. Offendit reprimique et has, eu mei homero imperdiet.Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.",        
        artistType:[{value:"Mixing engineer",label:"Mixing engineer"}],  //checkbox  https://soundbetter.com/s
        location:"USA",
        genre:"EDM, Heavy Metal, Hip Hop, House, Pop, Pop-RockRock",
        instrument:[{value:"Bass",label:"Bass"},{value:"Keyboard",label:"Keyboard"}],  //checkbox https://soundbetter.com/s
    ...
    },
    {
        ...
        location:"Barcelona",
        genre:"Pop-RockRock",
        instrument:[{value:"Guitar",label:"Guitar"}],  //checkbox https://soundbetter.com/s
